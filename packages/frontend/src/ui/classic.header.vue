...
<div class="azykntjl">
	<div class="body">
		...
		<div class="right">
			...
			<MkA v-click-anime v-tooltip="i18n.ts._tms.taiymeFeatures" class="item" activeClass="active" to="/tms/features" :behavior="settingsWindowed ? 'window' : null">
				<i class="ti ti-settings-plus ti-fw"></i>
			</MkA>
