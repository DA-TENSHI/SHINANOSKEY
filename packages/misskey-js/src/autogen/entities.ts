...
export type NotesVmimiHybridTimelineRequest = operations['notes___vmimi-hybrid-timeline']['requestBody']['content']['application/json'];
export type NotesVmimiHybridTimelineResponse = operations['notes___vmimi-hybrid-timeline']['responses']['200']['content']['application/json'];
